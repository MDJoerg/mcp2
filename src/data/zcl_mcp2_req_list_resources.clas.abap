"! <p class="shorttext synchronized">MCP2 resources/list request</p>
CLASS zcl_mcp2_req_list_resources DEFINITION PUBLIC FINAL CREATE PUBLIC.
...
CLASS zcl_mcp2_req_list_resources IMPLEMENTATION.
  METHOD constructor.
