"! <p class="shorttext synchronized">MCP2 tasks/get request</p>
CLASS zcl_mcp2_req_get_task DEFINITION PUBLIC FINAL CREATE PUBLIC.

  PUBLIC SECTION.
    "! <p class="shorttext synchronized">Parse a tasks/get params object</p>
    ...
    "! <p class="shorttext synchronized">Task id being queried</p>
...
CLASS zcl_mcp2_req_get_task IMPLEMENTATION.
  METHOD constructor.
    IF params IS NOT BOUND OR params->exists( '/taskId' ) = abap_false.
      zcx_mcp2_error=>raise_invalid_params( `tasks/get requires taskId` ) ##NO_TEXT.
    ENDIF.
