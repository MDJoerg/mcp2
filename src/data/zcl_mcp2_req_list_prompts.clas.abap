"! <p class="shorttext synchronized">MCP2 prompts/list request</p>
CLASS zcl_mcp2_req_list_prompts DEFINITION PUBLIC FINAL CREATE PUBLIC.
...
CLASS zcl_mcp2_req_list_prompts IMPLEMENTATION.
  METHOD constructor.
