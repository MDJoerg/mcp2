"! <p class="shorttext synchronized">MCP2 resources/templates/list request</p>
CLASS zcl_mcp2_req_list_res_tmpls DEFINITION PUBLIC FINAL CREATE PUBLIC.
...
CLASS zcl_mcp2_req_list_res_tmpls IMPLEMENTATION.
  METHOD constructor.
