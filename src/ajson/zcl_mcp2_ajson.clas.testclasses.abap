...
class lcl_nodes_helper definition final.
  public section.
    ...
    data mt_nodes type zif_mcp2_ajson_types=>ty_nodes_tt.
    methods add
      importing
        iv_str type string.
    methods clear.
    methods sorted
      returning
        value(rt_nodes) type zif_mcp2_ajson_types=>ty_nodes_ts.
...
class ltcl_parser_test definition final
  ...
  private section.
    ...
    methods setup.
    methods parse for testing raising zcx_mcp2_ajson_error.
    methods parse_keeping_order for testing raising zcx_mcp2_ajson_error.
    methods parse_string for testing raising zcx_mcp2_ajson_error.
    methods parse_number for testing raising zcx_mcp2_ajson_error.
    methods parse_float for testing raising zcx_mcp2_ajson_error.
    methods parse_boolean for testing raising zcx_mcp2_ajson_error.
    methods parse_false for testing raising zcx_mcp2_ajson_error.
    methods parse_null for testing raising zcx_mcp2_ajson_error.
    methods parse_date for testing raising zcx_mcp2_ajson_error.
    methods parse_bare_values for testing raising zcx_mcp2_ajson_error.
    methods parse_error for testing raising zcx_mcp2_ajson_error.
    methods parse_input_xstring for testing raising zcx_mcp2_ajson_error.
    methods parse_input_string for testing raising zcx_mcp2_ajson_error.
    methods parse_input_string_table for testing raising zcx_mcp2_ajson_error.
    methods parse_input_error for testing raising zcx_mcp2_ajson_error.
    methods duplicate_key for testing raising zcx_mcp2_ajson_error.
    methods non_json for testing raising zcx_mcp2_ajson_error.
    methods special_characters_in_name for testing raising zcx_mcp2_ajson_error.
    methods special_characters_in_path for testing raising zcx_mcp2_ajson_error.
    methods special_characters_in_value for testing raising zcx_mcp2_ajson_error.
    methods unicode_characters for testing raising zcx_mcp2_ajson_error.
    methods parse_empty_object for testing raising zcx_mcp2_ajson_error.
    methods parse_empty_string for testing raising zcx_mcp2_ajson_error.
...
class ltcl_parser_test implementation.
  ...
  method parse_bare_values.
    ...
    data lt_act type zif_mcp2_ajson_types=>ty_nodes_tt.
  ...
  method parse_error.
    ...
    data lt_act type zif_mcp2_ajson_types=>ty_nodes_tt.
    data lx_err type ref to zcx_mcp2_ajson_error.
    try.
      lt_act = mo_cut->parse( 'abc' ).
      cl_abap_unit_assert=>fail( 'Parsing of string w/o quotes must fail (spec)' ).
    catch zcx_mcp2_ajson_error into lx_err.
  ...
  method parse_input_error.
    ...
    data lx type ref to zcx_mcp2_ajson_error.
    ...
    catch zcx_mcp2_ajson_error into lx.
...
class ltcl_serializer_test definition final
  ...
  private section.
    ...
    methods stringify_condensed for testing raising zcx_mcp2_ajson_error.
    methods stringify_indented for testing raising zcx_mcp2_ajson_error.
    methods array_index for testing raising zcx_mcp2_ajson_error.
    methods item_order for testing raising zcx_mcp2_ajson_error.
    methods simple_indented for testing raising zcx_mcp2_ajson_error.
    methods empty_set for testing raising zcx_mcp2_ajson_error.
    methods escape_string for testing raising zcx_mcp2_ajson_error.
    methods empty for testing raising zcx_mcp2_ajson_error.
...
class ltcl_utils_test definition final
  ...
  private section.
    ...
    methods validate_array_index for testing raising zcx_mcp2_ajson_error.
    methods string_to_xstring_utf8 for testing.

endclass.

class zcl_mcp2_ajson definition local friends ltcl_utils_test.
...
class ltcl_utils_test implementation.
  ...
  method split_path.
    ...
    data ls_exp type zif_mcp2_ajson_types=>ty_path_name.
...
class ltcl_reader_test definition final
  ...
  private section.
    ...
    methods get_value for testing raising zcx_mcp2_ajson_error.
    methods get_node_type for testing raising zcx_mcp2_ajson_error.
    methods exists for testing raising zcx_mcp2_ajson_error.
    methods value_integer for testing raising zcx_mcp2_ajson_error.
    methods value_number for testing raising zcx_mcp2_ajson_error.
    methods value_boolean for testing raising zcx_mcp2_ajson_error.
    methods value_string for testing raising zcx_mcp2_ajson_error.
    methods members for testing raising zcx_mcp2_ajson_error.
    methods slice for testing raising zcx_mcp2_ajson_error.
    methods array_to_string_table for testing raising zcx_mcp2_ajson_error.
    methods get_date for testing raising zcx_mcp2_ajson_error.
    methods get_timestamp for testing raising zcx_mcp2_ajson_error.
    methods get_timestampl for testing raising zcx_mcp2_ajson_error.

endclass.

class zcl_mcp2_ajson definition local friends ltcl_reader_test.

class ltcl_reader_test implementation.

  method slice.

    data lo_cut type ref to zcl_mcp2_ajson.
    data lo_nodes type ref to lcl_nodes_helper.
    ...
    lo_cut = zcl_mcp2_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
    lo_cut ?= lo_cut->zif_mcp2_ajson~slice( '/issues' ).
    cl_abap_unit_assert=>assert_equals(
    ...
    lo_cut = zcl_mcp2_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
    lo_cut ?= lo_cut->zif_mcp2_ajson~slice( '/' ).
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->mt_json_tree
      exp = lo_nodes->sorted( ) ).
    ...
    lo_cut = zcl_mcp2_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
    lo_cut ?= lo_cut->zif_mcp2_ajson~slice( '/issues/2/start/' ).
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->mt_json_tree
      exp = lo_nodes->sorted( ) ).
  ...
  method get_value.
    ...
    data lo_cut type ref to zif_mcp2_ajson.
    lo_cut ?= zcl_mcp2_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
  ...
  method get_node_type.
    ...
    data li_cut type ref to zif_mcp2_ajson.
    li_cut = zcl_mcp2_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
    ...
    cl_abap_unit_assert=>assert_equals(
      ...
      exp = zif_mcp2_ajson_types=>node_type-string ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/number' )
      exp = zif_mcp2_ajson_types=>node_type-number ).
    cl_abap_unit_assert=>assert_equals(
    ...
    cl_abap_unit_assert=>assert_equals(
      ...
      exp = zif_mcp2_ajson_types=>node_type-array ).
  ...
  method get_date.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->zif_mcp2_ajson~get_date( '/date1' )
      exp = lv_exp ).
  ...
  method get_timestamp.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->zif_mcp2_ajson~get_timestamp( '/timestamp' )
      exp = lv_exp ).
  ...
  method get_timestampl.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->zif_mcp2_ajson~get_timestampl( '/timestamp' )
      exp = lv_exp ).
  ...
  method array_to_string_table.
    ...
    lt_act = lo_cut->zif_mcp2_ajson~array_to_string_table( '/' ).
    cl_abap_unit_assert=>assert_equals(
      act = lt_act
      exp = lt_exp ).
    ...
    try.
      lo_cut->zif_mcp2_ajson~array_to_string_table( '/x' ).
      cl_abap_unit_assert=>fail( ).
    catch zcx_mcp2_ajson_error into lx.
      cl_abap_unit_assert=>assert_equals(
        act = lx->message
    ...
    try.
      lo_cut->zif_mcp2_ajson~array_to_string_table( '/' ).
      cl_abap_unit_assert=>fail( ).
    catch zcx_mcp2_ajson_error into lx.
      cl_abap_unit_assert=>assert_equals(
        act = lx->message
    ...
    try.
      lo_cut->zif_mcp2_ajson~array_to_string_table( '/a' ).
      cl_abap_unit_assert=>fail( ).
    catch zcx_mcp2_ajson_error into lx.
      cl_abap_unit_assert=>assert_equals(
        act = lx->message
...
class zcl_mcp2_ajson definition local friends ltcl_json_to_abap.
...
class ltcl_json_to_abap implementation.
  ...
  method to_abap_corresponding_public.
    ...
    data ls_act type ty_struc.
    data ls_exp  type ty_struc.
    data li_json type ref to zif_mcp2_ajson.
    data lo_nodes type ref to lcl_nodes_helper.
  ...
  method to_abap_compressed_stdrd.
    ...
    data lo_ajson type ref to zcl_mcp2_ajson.
    ...
    lo_ajson = zcl_mcp2_ajson=>parse( lv_json ).
...
class ltcl_writer_test definition final
  ...
  private section.
    ...
    methods set_ajson for testing raising zcx_mcp2_ajson_error.
    methods slash_name_roundtrip for testing raising zcx_mcp2_ajson_error.
    methods set_value for testing raising zcx_mcp2_ajson_error.
    methods ignore_empty for testing raising zcx_mcp2_ajson_error.
    methods set_obj for testing raising zcx_mcp2_ajson_error.
    methods set_obj_w_date_time for testing raising zcx_mcp2_ajson_error.
    methods set_tab for testing raising zcx_mcp2_ajson_error.
    methods set_tab_hashed for testing raising zcx_mcp2_ajson_error.
    methods set_tab_nested_struct for testing raising zcx_mcp2_ajson_error.
    methods set_ref_to_data for testing raising zcx_mcp2_ajson_error.
    methods set_ref_to_data_struct for testing raising zcx_mcp2_ajson_error.
    methods prove_path_exists for testing raising zcx_mcp2_ajson_error.
    methods delete_subtree for testing raising zcx_mcp2_ajson_error.
    methods delete for testing raising zcx_mcp2_ajson_error.
    methods arrays for testing raising zcx_mcp2_ajson_error.
    methods arrays_negative for testing raising zcx_mcp2_ajson_error.
    methods root_assignment for testing raising zcx_mcp2_ajson_error.
    methods set_bool_abap_bool for testing raising zcx_mcp2_ajson_error.
    methods set_bool_int for testing raising zcx_mcp2_ajson_error.
    methods set_bool_tab for testing raising zcx_mcp2_ajson_error.
    methods set_str for testing raising zcx_mcp2_ajson_error.
    methods set_int for testing raising zcx_mcp2_ajson_error.
    methods set_number for testing raising zcx_mcp2_ajson_error.
    methods set_date for testing raising zcx_mcp2_ajson_error.
    methods set_timestamp for testing raising zcx_mcp2_ajson_error.
    methods set_timestampl for testing raising zcx_mcp2_ajson_error.
    methods set_utclong for testing raising zcx_mcp2_ajson_error.
    methods read_only for testing raising zcx_mcp2_ajson_error.
    methods set_array_obj for testing raising zcx_mcp2_ajson_error.
    methods set_with_type for testing raising zcx_mcp2_ajson_error.
    methods new_array_w_keep_order_touch for testing raising zcx_mcp2_ajson_error.
    methods overwrite_w_keep_order_touch for testing raising zcx_mcp2_ajson_error.
    methods overwrite_w_keep_order_set for testing raising zcx_mcp2_ajson_error.
    methods setx for testing raising zcx_mcp2_ajson_error.
    methods setx_float for testing raising zcx_mcp2_ajson_error.
    methods setx_complex for testing raising zcx_mcp2_ajson_error.
    methods setx_complex_w_keep_order for testing raising zcx_mcp2_ajson_error.

    methods set_with_type_slice
      importing
        io_json_in type ref to zcl_mcp2_ajson
        io_json_out type ref to zif_mcp2_ajson
        iv_path type string
      raising
...
class zcl_mcp2_ajson definition local friends ltcl_writer_test.

class ltcl_writer_test implementation.

  method slash_name_roundtrip.
    " mcp2 vendoring fix regression: members whose NAME contains a literal '/'
    " (e.g. _meta key "io.modelcontextprotocol/related-task") must keep their
    " children through set( ), stringify( ), parse( ) and re-grafting -
    " internal child paths use the TAB escape consistently on all code paths.
    data li_meta type ref to zif_mcp2_ajson.
    data li_related type ref to zif_mcp2_ajson.
    data li_doc type ref to zif_mcp2_ajson.
    data li_reparsed type ref to zif_mcp2_ajson.
    data li_envelope type ref to zif_mcp2_ajson.
    data lv_tab_path type string.
    data lv_exp type string.

    lv_tab_path = '/io.modelcontextprotocol' && cl_abap_char_utilities=>horizontal_tab && 'related-task'.

    li_related = zcl_mcp2_ajson=>create_empty( ).
    li_related->set(
      iv_path = '/taskId'
      iv_val  = 'T1' ).

    " graft a subtree under a slash-named member
    li_meta = zcl_mcp2_ajson=>create_empty( ).
    li_meta->set(
      iv_path = lv_tab_path
      iv_val  = li_related ).

    li_doc = zcl_mcp2_ajson=>create_empty( ).
    li_doc->set(
      iv_path = '/_meta'
      iv_val  = li_meta ).

    lv_exp = '{"_meta":{"io.modelcontextprotocol/related-task":{"taskId":"T1"}}}'.
    cl_abap_unit_assert=>assert_equals(
      act = li_doc->stringify( )
      exp = lv_exp ).

    " reads with the TAB-escaped path resolve on the set-built tree
    cl_abap_unit_assert=>assert_equals(
      act = li_doc->get_string( '/_meta' && lv_tab_path && '/taskId' )
      exp = 'T1' ).

    " the JSON-RPC envelope path: parse the wire and re-graft (this is what
    " serialize_response does) - children must survive the second stringify
    li_reparsed = zcl_mcp2_ajson=>parse( li_doc->stringify( ) ).
    li_envelope = zcl_mcp2_ajson=>create_empty( ).
    li_envelope->set(
      iv_path = '/result'
      iv_val  = li_reparsed ).
    lv_exp = '{"result":{"_meta":{"io.modelcontextprotocol/related-task":{"taskId":"T1"}}}}'.
    cl_abap_unit_assert=>assert_equals(
      act = li_envelope->stringify( )
      exp = lv_exp ).

    " deep set through a slash-named intermediate node
    data li_deep type ref to zif_mcp2_ajson.
    li_deep = zcl_mcp2_ajson=>create_empty( ).
    li_deep->set(
      iv_path = lv_tab_path && '/taskId'
      iv_val  = 'T2' ).
    lv_exp = '{"io.modelcontextprotocol/related-task":{"taskId":"T2"}}'.
    cl_abap_unit_assert=>assert_equals(
      act = li_deep->stringify( )
      exp = lv_exp ).

    " overwriting a slash-named subtree replaces it without orphans
    li_deep->set(
      iv_path = lv_tab_path
      iv_val  = zcl_mcp2_ajson=>parse( '{"taskId":"T3"}' ) ).
    lv_exp = '{"io.modelcontextprotocol/related-task":{"taskId":"T3"}}'.
    cl_abap_unit_assert=>assert_equals(
      act = li_deep->stringify( )
      exp = lv_exp ).
  endmethod.
  ...
  method prove_path_exists.
    ...
    lo_cut = zcl_mcp2_ajson=>create_empty( ).
  ...
  method delete.
    ...
    lo_cut->zif_mcp2_ajson~delete( iv_path = '/a/b' ).
  ...
  method set_ajson.
    ...
    data lo_nodes type ref to lcl_nodes_helper.
    data lo_src type ref to zcl_mcp2_ajson.
    data lo_cut type ref to zcl_mcp2_ajson.
    data li_writer type ref to zif_mcp2_ajson.

    lo_src = zcl_mcp2_ajson=>create_empty( ).
    lo_cut = zcl_mcp2_ajson=>create_empty( ).
    li_writer = lo_cut.
  ...
  method ignore_empty.
    ...
    li_cut = zcl_mcp2_ajson=>create_empty( ).
  ...
  method set_obj_w_date_time.
    ...
    lo_cut = zcl_mcp2_ajson=>create_empty( )->format_datetime( ).
    li_writer = lo_cut.
  ...
  method set_ref_to_data.
    ...
    lv_foo = 10.
    get reference of lv_foo into lr_foo.
  ...
  method set_ref_to_data_struct.
    ...
    lv_foo = `abc`.
    get reference of lv_foo into ls_struc-r.
  ...
  method set_number.
    ...
    li_json = zcl_mcp2_ajson=>create_empty( ).
    create object lo_nodes_exp.
    lo_nodes_exp->add( '        |      |object |         ||1' ).
  ...
  method set_with_type.
    ...
    data lo_sample type ref to zcl_mcp2_ajson.
    data lo_cut type ref to zcl_mcp2_ajson.
    data li_writer type ref to zif_mcp2_ajson.

    lo_sample = zcl_mcp2_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
  ...
  method setx.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp2_ajson=>new( )->setx( '/a:1' )->stringify( )
      exp = '{"a":1}' ).
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp2_ajson=>new( )->setx( '/a:abc' )->stringify( )
      exp = '{"a":"abc"}' ).

    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp2_ajson=>new( )->setx( '/a:null' )->stringify( )
      exp = '{"a":null}' ).

    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp2_ajson=>new( )->setx( '/a:true' )->stringify( )
      exp = '{"a":true}' ).
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp2_ajson=>new( )->setx( '/a:false' )->stringify( )
      exp = '{"a":false}' ).

    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp2_ajson=>new( )->setx( '/a/b:1' )->stringify( )
      exp = '{"a":{"b":1}}' ).

    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp2_ajson=>new( )->setx( '/:1' )->stringify( )
...
*    cl_abap_unit_assert=>assert_equals(
*      act = zcl_mcp2_ajson=>new( )->setx( '' )->stringify( )
*      exp = '{}' ). " problem is that root node not set so it is not an object

*    cl_abap_unit_assert=>assert_equals(
*      act = zcl_mcp2_ajson=>new( )->setx( '/a:' )->stringify( )
*      exp = '{}' ). " should setx ignore empty values or set an empty string ? Or null ?
  ...
  method setx_float.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp2_ajson=>new( )->setx( '/a:1.123' )->stringify( )
      exp = '{"a":1.123}' ).

    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp2_ajson=>new( )->setx( '/a:00.123' )->stringify( )
      exp = '{"a":"00.123"}' ). " not a number

    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp2_ajson=>new( )->setx( '/a:.123' )->stringify( )
      exp = '{"a":".123"}' ).
  ...
  method setx_complex.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp2_ajson=>new( )->setx( '/a:[1, 2]' )->stringify( )
      exp = '{"a":[1,2]}' ).
    ...
    try.
      zcl_mcp2_ajson=>new( )->setx( '/a:{"b" : 1' ).
      cl_abap_unit_assert=>fail( ).
    catch zcx_mcp2_ajson_error.
    endtry.

    try.
      zcl_mcp2_ajson=>new( )->setx( '/a:[1, 2' ).
      cl_abap_unit_assert=>fail( ).
    catch zcx_mcp2_ajson_error.
    endtry.
  ...
  method setx_complex_w_keep_order.
    ...
    li_cut = zcl_mcp2_ajson=>new( iv_keep_item_order = abap_true ).
    li_cut->setx( '/c:3' ).
    li_cut->set(
      iv_path = '/b'
      iv_val  = ls_dummy ).
...
class ltcl_integrated definition
  ...
  private section.
    ...
    methods reader for testing raising zcx_mcp2_ajson_error.
    methods array_index for testing raising zcx_mcp2_ajson_error.
    methods array_simple for testing raising zcx_mcp2_ajson_error.
    methods stringify for testing raising zcx_mcp2_ajson_error.
    methods item_order_integrated for testing raising zcx_mcp2_ajson_error.
    methods chaining for testing raising zcx_mcp2_ajson_error.
    methods push_json for testing raising zcx_mcp2_ajson_error.
    methods is_empty for testing raising zcx_mcp2_ajson_error.
...
class ltcl_integrated implementation.
  ...
  method array_simple.
    ...
    data li_reader type ref to zif_mcp2_ajson.
    li_reader = zcl_mcp2_ajson=>parse( lv_src ).
  ...
  method reader.
    ...
    li_reader = zcl_mcp2_ajson=>parse( lv_source ).
  ...
  method stringify.
    ...
    data: begin of ls_data, str type string, cls type ref to zcl_mcp2_ajson, end of ls_data.
  ...
  method push_json.
    ...
    data li_cut type ref to zif_mcp2_ajson.
    data li_sub type ref to zif_mcp2_ajson.
    data lv_act type string.
    data lv_exp type string.

    li_cut = zcl_mcp2_ajson=>create_empty( ).
    li_sub = zcl_mcp2_ajson=>create_empty( )->set(
      iv_path = 'a'
      iv_val  = '1' ).
    ...
    li_cut->push(
      iv_path = '/list'
      iv_val  = zcl_mcp2_ajson=>create_empty( )->set(
        iv_path = 'a'
        iv_val  = '1' ) ).
    li_cut->push(
      iv_path = '/list'
...
class ltcl_abap_to_json definition
  ...
  private section.
    ...
    methods set_ajson for testing raising zcx_mcp2_ajson_error.
    methods set_value_number for testing raising zcx_mcp2_ajson_error.
    methods set_value_string for testing raising zcx_mcp2_ajson_error.
    methods set_value_true for testing raising zcx_mcp2_ajson_error.
    methods set_value_false for testing raising zcx_mcp2_ajson_error.
    methods set_value_xsdboolean for testing raising zcx_mcp2_ajson_error.
    methods set_value_timestamp for testing raising zcx_mcp2_ajson_error.
    methods set_value_timestamp_initial for testing raising zcx_mcp2_ajson_error.
    methods set_value_timestampl for testing raising zcx_mcp2_ajson_error.
    methods set_value_timestampl_initial for testing raising zcx_mcp2_ajson_error.
    methods set_null for testing raising zcx_mcp2_ajson_error.
    methods set_obj for testing raising zcx_mcp2_ajson_error.
    methods set_array for testing raising zcx_mcp2_ajson_error.
    methods set_complex_obj for testing raising zcx_mcp2_ajson_error.
    methods set_include_with_suffix for testing raising zcx_mcp2_ajson_error.
    methods prefix for testing raising zcx_mcp2_ajson_error.

endclass.

class zcl_mcp2_ajson definition local friends ltcl_abap_to_json.
...
class ltcl_abap_to_json implementation.
  ...
  method set_ajson.
    ...
    data lt_nodes type zif_mcp2_ajson_types=>ty_nodes_tt.
  ...
  method prefix.
    ...
    data lo_nodes_exp type ref to lcl_nodes_helper.
    data lt_nodes type zif_mcp2_ajson_types=>ty_nodes_tt.
    data ls_prefix type zif_mcp2_ajson_types=>ty_path_name.
...
class ltcl_filter_test definition final
  ...
  public section.
    interfaces zif_mcp2_ajson_filter.
  ...
  private section.
    ...
    types:
      begin of ty_visit_history,
        path type string,
        type type zif_mcp2_ajson_filter=>ty_visit_type,
      end of ty_visit_history.

    data mt_visit_history type table of ty_visit_history.

    methods simple_test for testing raising zcx_mcp2_ajson_error.
    methods array_test for testing raising zcx_mcp2_ajson_error.
    methods visit_types for testing raising zcx_mcp2_ajson_error.
...
class ltcl_filter_test implementation.
  ...
  method zif_mcp2_ajson_filter~keep_node.
  ...
  method simple_test.
    ...
    data lo_json type ref to zcl_mcp2_ajson.
    data lo_json_filtered type ref to zcl_mcp2_ajson.
    data lo_nodes_exp type ref to lcl_nodes_helper.

    lo_json = zcl_mcp2_ajson=>create_empty( ).
    lo_json->set(
      iv_path = '/a'
      iv_val  = 1 ).
    lo_json->set(
    ...
    lo_json_filtered = zcl_mcp2_ajson=>create_from(
  ...
  method visit_types.
    ...
    <v>-path = '/'.
    <v>-type = zif_mcp2_ajson_filter=>visit_type-open.
    append initial line to lt_visits_exp assigning <v>.
    <v>-path = '/3/'.
    <v>-type = zif_mcp2_ajson_filter=>visit_type-open.
    append initial line to lt_visits_exp assigning <v>.
    <v>-path = '/3/'.
    <v>-type = zif_mcp2_ajson_filter=>visit_type-close.
    append initial line to lt_visits_exp assigning <v>.
    <v>-path = '/'.
    <v>-type = zif_mcp2_ajson_filter=>visit_type-close.
...
class ltcl_mapper_test definition final
  ...
  public section.
    interfaces zif_mcp2_ajson_mapping.

  private section.

    methods simple_test for testing raising zcx_mcp2_ajson_error.
    methods array_test for testing raising zcx_mcp2_ajson_error.
    methods duplication_test for testing raising zcx_mcp2_ajson_error.
    methods empty_name_test for testing raising zcx_mcp2_ajson_error.
    methods trivial for testing raising zcx_mcp2_ajson_error.

endclass.

class ltcl_mapper_test implementation.

  method zif_mcp2_ajson_mapping~rename_node.
    if cv_name+0(1) = 'a'.
  ...
  method zif_mcp2_ajson_mapping~to_abap.
  endmethod.

  method zif_mcp2_ajson_mapping~to_json.
  endmethod.
...
class ltcl_cloning_test definition final
  ...
  private section.
    ...
    methods clone_test for testing raising zcx_mcp2_ajson_error.
    methods filter_test for testing raising zcx_mcp2_ajson_error.
    methods mapper_test for testing raising zcx_mcp2_ajson_error.
    methods mapper_and_filter for testing raising zcx_mcp2_ajson_error.
    methods opts_copying for testing raising zcx_mcp2_ajson_error.
...
class ltcl_cloning_test implementation.
  ...
  method clone_test.
    ...
    data li_json type ref to zif_mcp2_ajson.
    data li_json_new type ref to zif_mcp2_ajson.
    data lo_nodes_exp type ref to lcl_nodes_helper.
  ...
  method mapper_and_filter.
    ...
    li_json_new = zcl_mcp2_ajson=>create_from(
  ...
  method opts_copying.
    ...
    li_json = zcl_mcp2_ajson=>new( )->keep_item_order( ).
    li_json->set(
      iv_path = '/ab'
      iv_val  = 1 ).
...
class ltcl_data_ref_test implementation.
  ...
  method to_abap_data_ref.
    ...
    data lo_cut type ref to lcl_json_to_abap.
    data li_refs type ref to zif_mcp2_ajson_ref_init.
    data lt_refs type zif_mcp2_ajson_ref_init=>tty_data_refs.
    ...
    li_refs = zcl_mcp2_ajson_ref_init_lib=>create_path_refs_init( lt_refs ).

    " to_abap
    create object lo_cut
      exporting
        ii_refs_initiator = li_refs.
